                ...
                <div className="row py-5">
                    ...
                    <div className="col col-lg-2 col-sm-6 p-5">
                        <nav className="nav flex-column">
                            <Link to="/" class="nav-link active" href="#">kaggledatasets</Link>
                            <Link to="/get-started" class="nav-link" href="#">Get Started</Link>
                            <Link to="/features" class="nav-link" href="#">Features</Link>
                            <a href="https://github.com/kaggledatasets/kaggledatasets" target="_blank" rel="noopener noreferrer" className="nav-link">Contributing</a>
                        </nav>
                    </div>
                    <div className="col col-lg-2 col-sm-6 p-5">
                        <nav className="nav flex-column">
                            <Link to="/resources" class="nav-link active" href="#">Resources</Link>
                            <Link to="/tutorials" class="nav-link" href="#">Tutorials</Link>
                            <Link to="/docs" class="nav-link" href="#">Docs</Link>
